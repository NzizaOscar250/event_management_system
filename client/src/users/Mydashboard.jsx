...
import {removeBookings } from "../actions/"
const Mydashboard = () => {
    ...
    <div className=' mx-auto'>
       ...
       <header className='p-2'>
           <h4 className='font-bold text-gray-700'>MY EVENTS</h4>
       </header>
      ...
      <div className="relative z-10 flex gap-2">
        ...
        <div className='flex gap-1 p-1'>
            <button onClick={()=>handleRemove(event.bookingId)}  className="bg-red-500 hover:bg-red-600 font-bold text-white p-2 rounded w-full ">Remove</button>
            <Link to={`/home/events/${event._id}`} className="bg-purple-500 hover:bg-purple-700 font-bold text-white p-2 rounded w-full text-center">View </Link>
        </div>
